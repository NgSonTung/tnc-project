...
# URL PATH
URL_PATH = ""
DEFAULT_BILLING_CALL_BACK_URL = "http://127.0.0.1:8001/home"
# dev or prod
if env == "production":
    JWT_COOKIE_SAMESITE = "None"
    JWT_COOKIE_DOMAIN = ".2gai.ai"
    ...
    TERM_URL = f"{URL_API_BE}/stage/index.html#/term"
    PRIVACY_URL = f"{URL_API_BE}/stage/index.html#/privacy-policy"
    WEBSITE_URL = f"{URL_API_BE}/stage/index.html#/home"
    URL_PATH = "/stage"
    DEFAULT_BILLING_CALL_BACK_URL = f"{URL_API_BE}/stage/home"
elif env == "docker":
    print("env", env)
    JWT_COOKIE_SECURE = False
    BASE_URL_DOCKER = os.environ.get("BASE_URL_STAGING_SERVER")
    STRIPE_API_SECRET_KEY = os.environ.get("STRIPE_API_SECRET_KEY_LIVE")
    STRIPE_ENDPOINTS_WEBHOOK_SECRET_KEY=os.environ.get("STRIPE_ENDPOINTS_WEBHOOK_SECRET_KEY_SERVER_LIVE")

...
from src.constants.http_status_codes import HTTP_200_OK, HTTP_500_INTERNAL_SERVER_ERROR, HTTP_404_NOT_FOUND, HTTP_200_OK, HTTP_400_BAD_REQUEST, HTTP_201_CREATED, HTTP_401_UNAUTHORIZED, HTTP_403_FORBIDDEN
    ...
    def decorator(fn):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                return jsonify({"code": 500, "message": "Internal server error", "error": str(e)}), HTTP_500_INTERNAL_SERVER_ERROR
...
class Controller:
    ...
    def get_all(model, req):
        try:
            ...
            return {"code": 200, f"data": data, "page": page * 1, "page_size": page_size * 1, "total_pages": total_pages * 1, "total_documents": total_documents * 1, "message": f"{model.__name__}s retrieved successfully"}, HTTP_200_OK
        except Exception as e:
            return {"code": 500, f"message": f"Failed to get {model.__name__}", "error": str(e)}, HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def get_by_id(model, req, id):
        try:
            ...
            return {"code": 200, "data": document.to_json(), "message": f"{model.__name__} retrieved successfully"}, HTTP_200_OK
        except Exception as e:
            return {"code": 500, f"message": f"Failed to get {model.__name__}", "error": str(e)}, HTTP_500_INTERNAL_SERVER_ERROR
    ...
    def create(model, req,):
        try:
            ...
            return {"code": 500, "message": f"Failed to create {model.__name__}", "error": str(e)}, HTTP_500_INTERNAL_SERVER_ERROR
